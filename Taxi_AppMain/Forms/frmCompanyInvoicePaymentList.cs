        ...
        private void LoadInvoiceList()
        {
            try
            {
                ...
                if (grdLister.CurrentRow != null && grdLister.CurrentRow is GridViewDataRowInfo)
                    lastRowId = grdLister.CurrentRow.Cells["Id"].Value.ToLong();
                ...
                if (optDefault.Checked)
                {
                    ...
                    using (TaxiDataContext db = new TaxiDataContext())
                    {
                        ...
                        var list = (from a in db.Invoices
                                    join b in db.Gen_Companies on a.CompanyId equals b.Id
                                    where (CompanyId == 0 || a.CompanyId == CompanyId)
                                    && (a.InvoicePaymentTypeID != null && a.InvoicePaymentTypeID == Enums.INVOICE_PAYMENTTYPES.FULLPAID)
                                    ...
                                    select new
                                    {
                                        ...
                                        InvoiceTotal = a.PaidAmount == null ? GetTotal(a, b) : a.PaidAmount,
                ...
                else if (OPTDESC.Checked)
                {
                   ...
                   (grdLister.Columns["InvoiceTotal"] as GridViewDecimalColumn).DecimalPlaces = 2;
                (grdLister.Columns["InvoiceTotal"] as GridViewDecimalColumn).FormatString = "{0:#,###0.00}";
                decimal InvoiceTotal = 0.00m;


                InvoiceTotal = grdLister.Rows.Sum(c => c.Cells[COLS.InvoiceTotal].Value.ToDecimal());
                lblInvoiceTotal.Text = "Total Paid Amount : " + string.Format("{0:f2}", InvoiceTotal);

                if (lastRowId > 0)
                {
                    grdLister.CurrentRow = grdLister.Rows.FirstOrDefault(c => c.Cells["Id"].Value.ToLong() == lastRowId);
            ...
            try
            {
                ...
                if (objCompany != null)
                {
                    ...
                    if (objCompany != null)
                    {
                        ...
                        if (objCompany.AdminFees > 0)
                        {
                            decimal GrandAmount = (invoiceGrandTotal.ToDecimal() );
                        ...
                        if (objCompany.HasVat.ToBool())
                        {
                            ...
                            valueAddedTax = (invoiceGrandTotal.ToDecimal() * 20) / 100;
                            ...
                            {
                                valueAddedTax = ((invoiceGrandTotal.ToDecimal() + AdminFees) * 20) / 100;
                ...
                invoiceGrandTotal =Math.Round ( ( ((invoiceGrandTotal + valueAddedTax) - discountAmount) + AdminFees).ToDecimal(),2);
            ...
            try
            {
                ...
                else if(gridCell.ColumnInfo.Name.ToLower()=="btnpay")
                {
                    ...
                    try
                    {
                        ...
                        //frmInvoicePayment frm = new frmInvoicePayment(id, InvoiceNo, Total);
                        frmPayment frm = new frmPayment(gridCell.RowInfo.Cells["CompanyId"].Value.ToInt(), gridCell.RowInfo.Cells["Id"].Value.ToInt(), gridCell.RowInfo.Cells["invoiceTotal"].Value.ToDecimal());
                        frm.MaximizeBox = false;
                        frm.ShowDialog();
                        frm.Dispose();
                    ...
                    using (TaxiDataContext db = new TaxiDataContext())
                    {
                        ...
                        if (companyId != 0)
                        {
                            ...
                            if (objCompany != null)
                            {
                                ...
                                invoiceGrandTotal = invoiceGrandTotal - discountAmount;
                                ...
                                if (objCompany.HasVat.ToBool())
                                {
                                    ...
                                    {
                                        valueAddedTax = ((invoiceGrandTotal+ AdminFees) * 20) / 100;
                                    }
                            ...
                            invoiceGrandTotal =Math.Round (( (netAmount + valueAddedTax + AdminFees) - discountAmount).ToDecimal(),2);
                            ...
                            invoiceGrandTotal = (netAmount + valueAddedTax + AdminFees) - discountAmount;
