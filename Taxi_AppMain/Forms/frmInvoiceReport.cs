    ...
    public partial class frmInvoiceReport : UI.SetupBase
    {
        ...
        public void GenerateReport()
        {
            try
            {
                ...
                if (objTemplate.TemplateName.ToStr() == "Template53")
                {
                    telNo = "Tel No. " + objSubCompany.TelephoneNo + ", Email:" + objSubCompany.EmailAddress.ToStr() + ", Website:" + objSubCompany.WebsiteUrl.ToStr();
                    email += " , " + objSubCompany.WebsiteUrl.ToStr();
                    address = objSubCompany.CompanyName.ToStr() + " , " + address;
                }
                ...
                else if (objTemplate.TemplateName.ToStr() == "Template21")
                {
                    vatNumber = "VAT No: " + objSubCompany.CompanyVatNumber.ToStr();
                }
                ...
                else if (objTemplate.TemplateName.ToStr() == "Template50" || objTemplate.TemplateName.ToStr() == "Template53")
                {
                    companyNumber = "Company Number: " + objSubCompany.CompanyNumber + " , VAT No: " + objSubCompany.CompanyVatNumber;
                    telNo = "Tel No. +44(0)" + objSubCompany.TelephoneNo.Substring(1);

                    if (objSubCompany.Fax.ToStr().Trim().Length > 0)
                        telNo += " Fax. " + objSubCompany.Fax;
                ...
                if (objTemplate.TemplateName.ToStr() == "Template6")
                    ...
                    || objTemplate.TemplateName.ToStr() == "Template9" || objTemplate.TemplateName.ToStr() == "Template10" || objTemplate.TemplateName.ToStr() == "Template49"
                    ...
                    || objTemplate.TemplateName.ToStr() == "Template23" || objTemplate.TemplateName.ToStr() == "Template52" || objTemplate.TemplateName.ToStr() == "Template25"
                ...
                if (objTemplate.TemplateName.ToStr() == "Template10" || objTemplate.TemplateName.ToStr() == "Template49" || objTemplate.TemplateName.ToStr() == "Template21"
                   ...
                   || objTemplate.TemplateName.ToStr() == "Template31" || objTemplate.TemplateName.ToStr() == "Template32"
                   || objTemplate.TemplateName.ToStr() == "Template48" || objTemplate.TemplateName.ToStr() == "Template50"
                   || objTemplate.TemplateName.ToStr() == "Template53" || objTemplate.TemplateName.ToStr() == "Template54")//|| objTemplate.TemplateName.ToStr() == "Template16")
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            if (objTemplate.TemplateName.ToStr() == "Template49")
                            {
                                ...
                                {
                                    footer += "\r\n" + objSubCompany.WebsiteUrl.ToStr() + " are part of " + "E-Travel Group";
                                }
                                else
                                {
                            ...
                            {
                                footer = "The debt shown in this invoice has been assigned to HSBC INVOICE FINANCE(UK) LTD, to whom cheques should be made payable and sent to them at Farncombe Road, Worthing, BN11 2BW.To pay by BACS please use sort code 40 - 47 - 25, account number 41015346.";
                                try
                                {
                                    using (TaxiDataContext db = new TaxiDataContext())
                                    {
                                        footer = db.ExecuteQuery<string>("select Footer from Gen_EmailSettings where formtype='invoice'").FirstOrDefault();
                                    }
                                }
                                catch
                                {
                ...
                if (objTemplate.TemplateName.ToStr() == "Template52")
                {
                    footer = "Any queries with invoice please contact the office on " + objSubCompany.TelephoneNo;
                }
                ...
                else if (objTemplate.TemplateName.ToStr() == "Template5")
                {
                   ...
                   || objTemplate.TemplateName.ToStr() == "Template31" || objTemplate.TemplateName.ToStr() == "Template32"
                    ...
                    || objTemplate.TemplateName.ToStr() == "Template50" || objTemplate.TemplateName.ToStr() == "Template54")
                {
                    ...
                    if (objTemplate.TemplateName.ToStr() == "Template10" || objTemplate.TemplateName.ToStr() == "Template49" || objTemplate.TemplateName.ToStr() == "Template16"
                        || objTemplate.TemplateName.ToStr() == "Template17" || objTemplate.TemplateName.ToStr() == "Template18"
                        || objTemplate.TemplateName.ToStr() == "Template25" || objTemplate.TemplateName.ToStr() == "Template45"
                        || objTemplate.TemplateName.ToStr() == "Template27" || objTemplate.TemplateName.ToStr() == "Template30"
                   || objTemplate.TemplateName.ToStr() == "Template31" || objTemplate.TemplateName.ToStr() == "Template32"
                   || objTemplate.TemplateName.ToStr() == "Template48" || objTemplate.TemplateName.ToStr() == "Template50" || objTemplate.TemplateName.ToStr() == "Template54")
                        minRows = 4;
                    ...
                    else if (objTemplate.TemplateName.ToStr() == "Template48" || objTemplate.TemplateName.ToStr() == "Template54")
                    {
                        if (objSubCompany.Fax.ToStr().Trim().Length > 0)
                            telNo += Environment.NewLine + "Fax No. " + objSubCompany.Fax;
                    }
                        ...
                        || objTemplate.TemplateName.ToStr() == "Template50" || objTemplate.TemplateName.ToStr() == "Template54")
                    {
                        ...
                        if (objTemplate.TemplateName.ToStr() == "Template54")
                        {
                            ...
                            param[25] = new Microsoft.Reporting.WinForms.ReportParameter("Report_Parameter_BLC", string.Format("{0:dd/MM/yyyy}", this.DataSource[0].FromDate) + " To: " + string.Format("{0:dd/MM/yyyy}", this.DataSource[0].TillDate));

                        }


                        if ((objTemplate.TemplateName.ToStr() == "Template10" || objTemplate.TemplateName.ToStr() == "Template49" || objTemplate.TemplateName.ToStr() == "Template32" || objTemplate.TemplateName.ToStr() == "Template45") && this.ExportFileType.ToStr().ToLower() == "excel")
                        {
                            if (HasSplitByField == "Split By Department")
                            {
                                //this.reportViewer1.LocalReport.ReportEmbeddedResource = className + "SplitByDept_rptCompanyInvoice.rdlc";
                ...
                else if (objTemplate.TemplateName.ToStr() == "Template18")
                {
                    ...
                    if (objSubCompany.Id == 4)
                    {
                        //netAmount
                        DriverCostNonVAT = 0.0m;
                        BusinessCharge = 0.0m;
                        VatOnBusinessCharge = ((invoiceGrandTotal * 20) / 100);
                        TotalGPB = invoiceGrandTotal + (DriverCostNonVAT + BusinessCharge + VatOnBusinessCharge);
                    }
                    else
                    {
                ...
                else if (objTemplate.TemplateName.ToStr() == "Template10" || objTemplate.TemplateName.ToStr() == "Template49")
                {
                    ...
                    || objTemplate.TemplateName.ToStr() == "Template45" || objTemplate.TemplateName.ToStr() == "Template48" || objTemplate.TemplateName.ToStr() == "Template50" || objTemplate.TemplateName.ToStr() == "Template54"
                    )
                {
          ...
          .FirstOrDefault();
                ...
                else if (objTemplate.TemplateName.ToStr() == "Template52")
                {
                ...
                if (companyId != null)
                {
                    ...
                    if (objCompany != null)
                    {
                        ...
                        if (objCompany.HideBankDetails.ToBool())
                        {
                            hasBankDetails = "0";
                        }
                            ...
                            || objTemplate.TemplateName.ToStr() == "Template50" || objTemplate.TemplateName.ToStr() == "Template53")
                        {
                            if (vat == "1")
                            {
                                ...
                                if (objCompany.VatOnlyOnAdminFees.ToBool() == false)
                                {
                ...
                {
                    if (objSubCompany.Id == 4)
                        param[24] = new Microsoft.Reporting.WinForms.ReportParameter("Report_Parameter_IBAN", "0");
                    else
                        param[24] = new Microsoft.Reporting.WinForms.ReportParameter("Report_Parameter_IBAN", "1");
                    //param[24] = new Microsoft.Reporting.WinForms.ReportParameter("Report_Parameter_IBAN", "IBAN No : " + objSubCompany.IbanNumber.ToStr());
                    param[25] = new Microsoft.Reporting.WinForms.ReportParameter("Report_Parameter_BLC", "SWIFT Code : " + objSubCompany.BlcNumber.ToStr());
                ...
                PageSettings pgSettings = new PageSettings
                {
                    ...
                    Margins = new Margins(10, 10, 50, 50)       // Set margins (optional)
                };
        ...
        private void InitialializeAllReport()
        {
            ...
            this.btnPrintAll.Visible = true;
            this.btnPrintAll.Click += BtnPrintAll_Click;
            ...
            this.myDatePicker1.Format = System.Windows.Forms.DateTimePickerFormat.Custom;
            ...
            this.myDatePicker2.Format = System.Windows.Forms.DateTimePickerFormat.Custom;
