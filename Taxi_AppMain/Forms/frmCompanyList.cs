    ...
    public partial class frmCompanyList : UI.SetupBase
    {
        ...
        public override void PopulateData()
        {
            ...
            try
            {
                ...
                bool closedAccounts = CHKcLOSEDACCOUNTS.Checked;
                ...
                using (TaxiDataContext db = new TaxiDataContext())
                {
                   ...
                   // var data1 =d.OrderBy(c => c.CompanyName);
                    ...
                    var query = from a in db.Gen_Companies
                                ...
                                join c in db.Gen_CompanyGroups on a.GroupId equals c.Id into table3
                                from b in table2.DefaultIfEmpty()
                                from c in table3.DefaultIfEmpty()
                                where
                                 (  (closedAccounts==false && (a.IsClosed==null || a.IsClosed==false) ) || closedAccounts==true )
        ...
        void frmCompanyList_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                grdLister.Columns["Address"].Width = 130;

                grdLister.Columns["Telephone"].Width = 60;
                grdLister.Columns["Mobile"].Width = 60;
                grdLister.Columns["ContactName"].Width = 70;
                grdLister.Columns["ContactName"].HeaderText = "Contact Name";

                grdLister.Columns["SubCompany"].Width = 80;

                grdLister.Columns["Group"].Width = 60;
                ...
                CHKcLOSEDACCOUNTS.CheckedChanged += CHKcLOSEDACCOUNTS_CheckedChanged;
        ...
        private void CHKcLOSEDACCOUNTS_CheckedChanged(object sender, EventArgs e)
        {
            PopulateData();
        }
