...
namespace Taxi_AppMain
{
    public partial class frmDriversList : UI.SetupBase
    {
            ...
            try
            {
                ...
                if ((AppVars.frmMDI.ActiveControl != null && AppVars.frmMDI.ActiveControl.Name.Equals("frmDriversList1") == true))
                {
                    ...
                    foreach (var item in grdLister.Rows)
                    {
                        ...
                        if (item.Cells["MOT"] != null && item.Cells["MOT"].Value.ToStr()!="")
                        {
                        ...
                        if (item.Cells["MOT2"] != null)
                        {

                            if (item.Cells["MOT2"].Value.ToDate() < dtNow)
                            {
                                item.Cells["MOT2"].Style.BackColor = Color.Pink;
                                item.Cells["MOT2"].Style.CustomizeFill = true;

                            }
                            else if (item.Cells["MOT2"].Value.ToDate() < dtNow.AddDays(MOT2Days))
                            {

                                if (item.Cells["MOT2"].Style.BackColor == Color.White)
                                {

                                    item.Cells["MOT2"].Style.BackColor = Color.Lavender;
                                }
                                else
                                {

                                    item.Cells["MOT2"].Style.BackColor = Color.White;
                                }
                        ...
                        if (item.Cells["Road Tax"] != null)
                        {

                            if (item.Cells["Road Tax"].Value.ToDate() < dtNow)
                            {
                                item.Cells["Road Tax"].Style.BackColor = Color.Pink;
                                item.Cells["Road Tax"].Style.CustomizeFill = true;

                            }
                            else if (item.Cells["Road Tax"].Value.ToDate() < dtNow.AddDays(RoadTaxDays))
                            {

                                if (item.Cells["Road Tax"].Style.BackColor == Color.White)
                                {

                                    item.Cells["Road Tax"].Style.BackColor = Color.Lavender;
                                }
                                else
                                {
                        ...
                        if (item.Cells["License"] != null && item.Cells["License"].Value.ToStr() != "")
                        {

                            if (item.Cells["License"].Value.ToDate() < dtNow)
                            {
                                item.Cells["License"].Style.BackColor = Color.Pink;
                                item.Cells["License"].Style.CustomizeFill = true;

                            }
                            else if (item.Cells["License"].Value.ToDate() < dtNow.AddDays(LicenseDays))
                            {

                                if (item.Cells["License"].Style.BackColor == Color.White)
                                {

                                    item.Cells["License"].Style.BackColor = Color.PaleGoldenrod;
                                }
                                else
                                {

                                    item.Cells["License"].Style.BackColor = Color.White;
                                }
                        ...
                        if (item.Cells["PHC Vehicle"] != null && item.Cells["PHC Vehicle"].Value.ToStr() != "")
                        {



                            if (item.Cells["PHC Vehicle"].Value.ToDate() < dtNow)
                            {
                                item.Cells["PHC Vehicle"].Style.BackColor = Color.Pink;
                                item.Cells["PHC Vehicle"].Style.CustomizeFill = true;

                            }
                            else if (item.Cells["PHC Vehicle"].Value.ToDate() < dtNow.AddDays(PHCVehicleDays))
                            {

                                if (item.Cells["PHC Vehicle"].Style.BackColor == Color.White)
                                {

                                    item.Cells["PHC Vehicle"].Style.BackColor = Color.Orange;
                                }
                                else
                                {

                                    item.Cells["PHC Vehicle"].Style.BackColor = Color.White;
                                }
                        ...
                        if (item.Cells["PHC Driver"] != null && item.Cells["PHC Driver"].Value.ToStr() != "")
                        {

                            if (item.Cells["PHC Driver"].Value.ToDate() < dtNow)
                            {
                                item.Cells["PHC Driver"].Style.BackColor = Color.Pink;
                                item.Cells["PHC Driver"].Style.CustomizeFill = true;

                            }
                            else if (item.Cells["PHC Driver"].Value.ToDate() < dtNow.AddDays(PHCDriverDays))
                            {

                                if (item.Cells["PHC Driver"].Style.BackColor == Color.White)
                                {

                                    item.Cells["PHC Driver"].Style.BackColor = Color.Gainsboro;
                                }
                                else
                                {

                                    item.Cells["PHC Driver"].Style.BackColor = Color.White;
                                }
                        ...
                        if (item.Cells["Insurance"] != null && item.Cells["Insurance"].Value.ToStr() != "")
                        {

                            if (item.Cells["Insurance"].Value.ToDateTime() < DateTime.Now)
                            {
                                item.Cells["Insurance"].Style.BackColor = Color.Pink;
                                item.Cells["Insurance"].Style.CustomizeFill = true;

                            }
                            else if (item.Cells["Insurance"].Value.ToDateTime() < DateTime.Now.AddDays(InsuranceDays))
                            {
                        ...
                        if (item.Cells["School Badge"] != null && item.Cells["School Badge"].Value.ToStr() != "")
                        {

                            if (item.Cells["School Badge"].Value.ToDate() < dtNow)
                            {
                                item.Cells["School Badge"].Style.BackColor = Color.Pink;
                                item.Cells["School Badge"].Style.CustomizeFill = true;

                            }
                            else if (item.Cells["School Badge"].Value.ToDate() < dtNow.AddDays(PHCDriverDays))
                            {

                                if (item.Cells["School Badge"].Style.BackColor == Color.White)
                                {

                                    item.Cells["School Badge"].Style.BackColor = Color.Gainsboro;
                                }
                                else
                                {

                                    item.Cells["School Badge"].Style.BackColor = Color.White;
                                }
        ...
        private void PopulateUI(DataTable list)
        {
            try
            {
                if (IsClosed)
                ...
                lblTotal.Text = "Total Driver(s) : " + list.Rows.Count.ToStr();
            }
            catch (Exception ex)
            {
                hasError = true;
        ...
        private void ShowUI(bool show, string message)
        {
            ...
            if (hasError)
            {
             ...
             else
             {
                ...
                grdLister.Columns["Rating"].IsVisible = false;
                ...
                //foreach (var item in grdLister.Columns)
                //{
                    
                //        if (item.Name == "Insurance")
                //        {
                //        (grdLister.Columns[item.Index]).FormatInf.ConvertTo(grdLister.Columns[item.Index], typeof(GridViewDateTimeColumn));
                //          //  (grdLister.Columns[item.Index] ).CustomFormat = "dd/MM/yyyy HH:mm";

                //        }
                //        else
                //        {
                //            (grdLister.Columns[item.Index] ).FormatString = "{0:dd/MM/yyyy}";
                //          //  (grdLister.Columns[item.Index] as GridViewDateTimeColumn).CustomFormat = "dd/MM/yyyy";
                //        }
        ...
        delegate void UIDelegate(DataTable list);
        ...
        void worker_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            if (this.InvokeRequired)
            {
                ...
                this.BeginInvoke(del, dataTable);
        ...
        public override void PopulateData()
        {
            try
            {
                ...
                //    var list = db.ExecuteQuery("exec stp_GetDriverRecords {0}", AppVars.DefaultDriverSubCompanyId);
                ...
                string CommandText = "stp_GetDriverRecords";
                cmd = new SqlCommand(CommandText);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add(new SqlParameter("@SubCompanyId", AppVars.DefaultDriverSubCompanyId));

                //cmd.Parameters.AddWithValue("SubCompanyId", AppVars.DefaultDriverSubCompanyId);
                cmd.Connection = con;

                reader = cmd.ExecuteReader();

           //   var l=    reader.Cast<IList>();
