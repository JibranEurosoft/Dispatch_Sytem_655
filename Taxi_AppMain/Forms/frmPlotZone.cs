    ...
    public partial class frmPlotZone : UI.SetupBase
    {
        ...
        private void radButton1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                RadListDataItem item = lstZones.SelectedItem;
                int index = lstZones.SelectedIndex;
                lstZones.Items.Remove(item);
                lstZones.Items.Insert(0, item);
                lstZones.SelectedItem = item;
            }
            catch
            {
