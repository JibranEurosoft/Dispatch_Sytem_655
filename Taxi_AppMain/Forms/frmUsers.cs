    ...
    public partial class frmUsers : SetupBase
    {
        ...
        private void frmUsers_Load(object sender, EventArgs e)
        {
         ...
         //   grdUsers.Columns["ColDelete"].Width = 70;
            ...
            //if(AppVars.objPolicyConfiguration.EnableOnBoardDrivers.ToBool()==false) // new layout
            //{
        ...
        private void FillCombos()
        {
         ...
         //   ThemeList themeList = ThemeResolutionService.GetAvailableThemes();
            ...
            //{
                ddlThemes.Items.Add(new RadListDataItem { Text = "ControlDefault", Value = "ControlDefault" });
                ddlThemes.Items.Add(new RadListDataItem { Text = "HighContrastBlack", Value = "HighContrastBlack" });
        ...
        public override void Save()
        {
            ...
            try
            {
                ...
                if(ddlThemes.Visible && ddlThemes.SelectedIndex!=0)
                {
                    objMaster.Current.ThemeName = ddlThemes.Text.Trim();
