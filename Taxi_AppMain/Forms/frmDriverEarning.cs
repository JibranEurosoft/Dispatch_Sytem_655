...
namespace Taxi_AppMain
{
    public partial class frmDriverEarning : Form
    {
        ...
        public frmDriverEarning()
        {
            ...
            grdCurrentEarning.CellDoubleClick += GrdCurrentEarning_CellDoubleClick;
            grdWeeklyEarning.CellDoubleClick += GrdCurrentEarning_CellDoubleClick;
            grdTodayEarning.CellDoubleClick += GrdCurrentEarning_CellDoubleClick;
            
       }

        private void GrdCurrentEarning_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                if (e.RowIndex >= 0)
                {
                    ...
                    if(grid.Name.ToLower()=="grdweeklyearning")
                        jobId= grid.Rows[e.RowIndex].Cells["Id"].Value.ToLong();
                    else if (grid.Name.ToLower() == "grdcurrentearning")
                        jobId = grid.Rows[e.RowIndex].Cells["curId"].Value.ToLong();
                    if (grid.Name.ToLower() == "grdtodayearning")
                        jobId = grid.Rows[e.RowIndex].Cells["tId"].Value.ToLong();
        ...
        {
            ComboFunctions.FillDriverNoCombo(ddlDriver,c => c.IsActive == true && (AppVars.DefaultDriverSubCompanyId == 0 || c.SubcompanyId == AppVars.DefaultDriverSubCompanyId));
            ...
            try
            {
                ...
                TimeSpan.TryParse("23:59:59", out tillTime);
                  ...
                  if (obj != null)
                  {
                      ...
                      var list = (from a in General.GetQueryable<Booking>(c => (c.PickupDateTime != null && c.PickupDateTime >= dtpFrom.Value.ToDate() && c.PickupDateTime <= dtpTill.Value.ToDate() + tillTime) && (c.DriverId == driverId )
        ...
        private void DefaultEarning(int DriverId)
        {
            try
            {
                ...
                if (obj != null)
                {
                    ...
                    var list = (from a in General.GetQueryable<Booking>(c => (c.PickupDateTime != null && c.PickupDateTime >= loginDateTime) && (c.DriverId == driverId )
                                                         && c.BookingStatusId == Enums.BOOKINGSTATUS.DISPATCHED && c.Fleet_Driver.DriverTypeId == driverType)
                                select new
                                {
                                    FareRate = a.FareRate
                ...
                if (obj != null)
                {
                    ...
                    var listWeekly = (from a in General.GetQueryable<Booking>(c => (c.PickupDateTime != null && c.PickupDateTime >= dtFrom && c.PickupDateTime <= dtToday.ToDate() + tillTime) && (c.DriverId == driverId )
                                     && c.BookingStatusId == Enums.BOOKINGSTATUS.DISPATCHED && c.Fleet_Driver.DriverTypeId == driverType)
                                      select new
                                      {
                                          FareRate = a.FareRate
                    ...
                    var listToday = (from a in General.GetQueryable<Booking>(c => (c.PickupDateTime != null && c.PickupDateTime >= dtToday && c.PickupDateTime <= dtToday.ToDate() + tillTime) && (c.DriverId == driverId )
                                     && c.BookingStatusId == Enums.BOOKINGSTATUS.DISPATCHED && c.Fleet_Driver.DriverTypeId == driverType)
                                     select new
                                     {
                                         FareRate = a.FareRate
            ...
            try
            {
                ...
                if (obj != null)
                {
                    ...
                    if (AppVars.objPolicyConfiguration.EarningLoginHours.ToInt() > 0)
                    {
                        ...
                        loginDateTime = loginDateTime.Value.AddMinutes(-AppVars.objPolicyConfiguration.EarningLoginHours.ToInt());
                    ...
                    var list = (from a in General.GetQueryable<Booking>(c => c.PickupDateTime >= loginDateTime
                            && (c.DriverId == driverId )
        ...
        private void txtCurParking_Click(object sender, EventArgs e)
        {
