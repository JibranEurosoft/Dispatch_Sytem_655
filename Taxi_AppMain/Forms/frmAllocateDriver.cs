...
namespace Taxi_AppMain
{
    public partial class frmAllocateDriver : Form
    {
        ...
        void frmAllocateDriver_Shown(object sender, EventArgs e)
        {
            ...
            if(AppVars.ShowAllocatedConfirmedDriver==null)
            {
            ...
            if (AppVars.objPolicyConfiguration.BookingFormType.ToInt() == 1 || AppVars.ShowAllocatedConfirmedDriver.ToBool() == true)
            {
                chkConfirmed.Visible = true;

                if (ObjMaster != null && ObjMaster.Current != null && ObjMaster.Current.IsConfirmedDriver.ToBool() == false)
