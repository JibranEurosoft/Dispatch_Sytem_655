    ...
    public partial class frmCompanyDepartments : UI.SetupBase
    {
        ...
        public override void Save()
        {
            try
            {
                ...
                SaveInvoiceNote(objMaster.Current.Id, txtInvoiceNote.Text.Trim());
        ...
        private void SaveInvoiceNote(long Id,string note)
        {
            try
            {
                using (TaxiDataContext db = new TaxiDataContext())
                {
                    db.ExecuteQuery<int>("update gen_company_departments set invoicenote='" + note + "' where id=" + Id);
        ...
        public override void DisplayRecord()
        {
            ...
            try
            {
                ...
                using (TaxiDataContext db = new TaxiDataContext())
                {
                    note = db.ExecuteQuery<string>("select InvoiceNote from gen_company_departments where id=" + objMaster.Current.Id).FirstOrDefault();
                }

                txtInvoiceNote.Text = note;
            }
            catch
            { }
