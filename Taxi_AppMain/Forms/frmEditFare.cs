                ...
                ObjMaster.AllowUpdateTransaction = allowUpdateTransaction;
                    ...
                    if (ObjMaster.Current.CompanyId == null)
                    {
                        ObjMaster.Current.TotalCharges = ObjMaster.Current.FareRate.ToDecimal()
                                     + ObjMaster.Current.ExtraDropCharges.ToDecimal() + ObjMaster.Current.MeetAndGreetCharges.ToDecimal() + ObjMaster.Current.CongtionCharges.ToDecimal() + ObjMaster.Current.ServiceCharges.ToDecimal();
                    }
                    else
                    {
                        ObjMaster.Current.TotalCharges = ObjMaster.Current.CompanyPrice.ToDecimal() + ObjMaster.Current.ParkingCharges.ToDecimal() + ObjMaster.Current.WaitingCharges.ToDecimal() + ObjMaster.Current.ExtraDropCharges.ToDecimal() + ObjMaster.Current.ServiceCharges.ToDecimal();
