...
{
    public partial class frmEscortInvoice : UI.SetupBase
    {
            ...
            try
            {
                ...
                if (gridCell.ColumnInfo.Name == "btnUpdate")
                {
                   ...
                   //     int? VehicleID = row.Cells[COLS.VehicleID].Value.ToInt();
                        ...
                        {
                            objMaster.Current.EscortPrice = fare;
       ...
       //     colD.Expression = "Charges+Parking+Waiting+ExtraDrop+MeetAndGreet+CongtionCharge";
        ...
        private void OnSave()
        {
            ...
            try
            {
                ...
                objMaster.Current.EscortId = ddlEscort.SelectedValue.ToIntorNull();
               ...
               // objMaster.Current.CostCenterWise=chkCostCenterWise.Checked;
                ...
                objMaster.Current.InvoiceTypeId = Enums.INVOICE_TYPE.ESCORT_INVOICE;
          ...
          //  chkCostCenterWise.Checked=objMaster.Current.CostCenterWise.ToBool();
            ...
            for (int i = 0; i < cnt; i++)
            {
                ...
                if (objBooking != null)
                {
                    ...
                    grdLister.Rows[i].Cells[COLS.Charges].Value = objBooking.EscortPrice.ToDecimal();
                    ...
                    grdLister.Rows[i].Cells[COLS.Total].Value = objBooking.EscortPrice.ToDecimal();
        ...
        private void btnPickBooking_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int escortId = ddlEscort.SelectedValue.ToInt();
                ...
                hiddenColumns = new string[] {  "Id", "CompanyId","Parking","Destination","Waiting","ExtraDrop","MeetAndGreet","Congtion",
                ...
                List<object[]> list = General.ShowEscortInvoiceBookingMultiLister(c => c.EscortId == escortId 
                        && (c.BookingStatusId == Enums.BOOKINGSTATUS.DISPATCHED)
                                      && ((ForProcessedJobs == true
                                && (c.IsProcessed != null && c.IsProcessed == true)) || (ForProcessedJobs == false && (c.IsProcessed == null || c.IsProcessed == false)))
                    
                 
                                                                      
                                                                       ,
                                                                         a=>a.Invoice.InvoiceTypeId == Enums.INVOICE_TYPE.ESCORT_INVOICE,
        ...
        private void ddlCompany_SelectedValueChanged(object sender, EventArgs e)
        {
           ...
           // int? Id = ddlEscort.SelectedValue.ToIntorNull();
        ...
        public override void Print()
        {
            ...
            frmEscortInvoiceReport frm = new frmEscortInvoiceReport();
            ...
            DockWindow doc = UI.MainMenuForm.MainMenuFrm.GetDockByName("frmEscortInvoiceReport1");
        ...
        public override void OnNew()
        {
            ...
            ComboFunctions.FillCompanyCombo(ddlEscort);
        ...
        private void btnSendEmail_Click(object sender, EventArgs e)
        {
            ...
            this.companyEmail=  General.GetObject<Gen_Escort>(c => c.Id == objMaster.Current.EscortId).DefaultIfEmpty().EmailAddress.ToStr().Trim();
