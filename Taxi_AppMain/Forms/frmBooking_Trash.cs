...
namespace Taxi_AppMain
{
   ...
   //     private bool IsExistData = false;
        ...
        //                string frmaddress = ddlFromLocation.Visible == false ? txtFromAddress.Text == null ? "null" : txtFromAddress.Text : ((Telerik.WinControls.UI.RadDropDownListItem)(ddlFromLocation.SelectedItem)).Text.ToStr();
        //                string Toaddress = ddlToLocation.Visible == false ? txtToAddress.Text == null ? "null" : txtToAddress.Text : ((Telerik.WinControls.UI.RadDropDownListItem)(ddlToLocation.SelectedItem)).Text.ToStr();
