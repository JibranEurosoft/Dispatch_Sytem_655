    ...
    public partial class frmShowSetFares : UI.SetupBase
    {
      ...
      //  delegate void UIDelegate(List<Fare_CustomJourney> list);   
            ...
            try
            {
                ...
                var list = (from obj in General.GetQueryable<Fare_CustomJourney>(c => c.Id != null)
                            select new
                            {
                                ...
                                AgentComm= obj.AgentCommission,
                                AgentRtnComm=obj.RtnAgentCommission,
                                AgentCharge=obj.AgentCharge,
                                AgentRtnCharge=obj.RtnAgentCharge,
                                DriverId = obj.DriverId,
                                EscortId = obj.EscortId,
                                CompanyName = obj.Gen_Company.CompanyName,
                                obj.VehicleTypeId,
                                obj.Fleet_VehicleType.VehicleType
                            }).ToList();
                ...
                for (int i = 0; i < grdFares.RowCount; i++)
                {
                    ...
                    grdFares.Rows[i].Cells["AgentComm"].Value = list[i].AgentComm;
                    grdFares.Rows[i].Cells["RtnAgentComm"].Value = list[i].AgentRtnComm;

                    grdFares.Rows[i].Cells["AgentCharge"].Value = list[i].AgentCharge;
                    grdFares.Rows[i].Cells["RtnAgentCharge"].Value = list[i].AgentRtnCharge;
                    ...
                    grdFares.Rows[i].Cells["Vehicle"].Value = list[i].VehicleType.ToStr();
        ...
        private void FormatFaresGrid()
        {
            ...
            colDec = new GridViewDecimalColumn();
            colDec.HeaderText = "Agent Comm";
            colDec.Name = "AgentComm";
            colDec.Width = 80;
            colDec.DecimalPlaces = 2;           
            colDec.ThousandsSeparator = true;
            grdFares.Columns.Add(colDec);
            ...
            colDec = new GridViewDecimalColumn();
            colDec.HeaderText = "Agent Charge";
            colDec.Name = "AgentCharge";
            colDec.Width = 80;
            colDec.DecimalPlaces = 2;
            colDec.ThousandsSeparator = true;
            grdFares.Columns.Add(colDec);
            ...
            colDec = new GridViewDecimalColumn();
            colDec.HeaderText = "Rtn Agent Comm";
            colDec.Name = "RtnAgentComm";
            colDec.Width = 80;
            colDec.DecimalPlaces = 2;
            colDec.ThousandsSeparator = true;
            grdFares.Columns.Add(colDec);
            ...
            colDec = new GridViewDecimalColumn();
            colDec.HeaderText = "Rtn Agent Charge";
            colDec.Name = "RtnAgentCharge";
            colDec.Width = 80;
            colDec.DecimalPlaces = 2;
            colDec.ThousandsSeparator = true;
            grdFares.Columns.Add(colDec);
                ...
                if (name == "update")
                {
                    ...
                    if (grid.CurrentRow != null && grid.CurrentRow is GridViewDataRowInfo)
                    {
                        ...
                        if (objeCustomBO.Current != null)
                        {
                            ...
                            objeCustomBO.Current.AgentCommission = grid.CurrentRow.Cells["AgentComm"].Value.ToDecimal();
                            objeCustomBO.Current.AgentCharge = grid.CurrentRow.Cells["AgentCharge"].Value.ToDecimal();

                            objeCustomBO.Current.RtnAgentCommission = grid.CurrentRow.Cells["RtnAgentComm"].Value.ToDecimal();
                            objeCustomBO.Current.RtnAgentCharge = grid.CurrentRow.Cells["RtnAgentCharge"].Value.ToDecimal();
