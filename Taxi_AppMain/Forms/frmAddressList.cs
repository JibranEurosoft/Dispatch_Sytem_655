...
namespace Taxi_AppMain
{
    public partial class frmAddressList :UI.SetupBase
    {
        ...
        private void EditAddress(string name)
        {
            if (grdLister.CurrentRow != null && grdLister.CurrentRow is GridViewDataRowInfo)
            {
                ...
                if (name == "btnEditAddress")
                {
                    ...
                    frmAddNewAddress frm = new frmAddNewAddress(Id, Address, 0, grdLister.CurrentRow.Cells["PostCode"].Value.ToStr(), grdLister.CurrentRow.Cells["Source"].Value.ToStr());
                    frm.ShowDialog();
                ...
                if (HasError == false)
                {
                 ...
                 //   grdLister.Columns["Address"].SortOrder = RadSortOrder.Ascending;
                   ...
                   // grdLister.Columns["ZoneId"].IsVisible = false;
                    ...
                    grdLister.Columns["Source"].IsVisible = false;
                    GridButton();
