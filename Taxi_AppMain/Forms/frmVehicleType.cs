...
namespace Taxi_AppMain
{
    public partial class frmVehicleType : UI.SetupBase
    {
        ...
        void frmVehicleType_Shown(object sender, EventArgs e)
        {
            ...
            if(AppVars.objPolicyConfiguration.BookingFormType.ToInt()==1)
            {
        ...
        public override void DisplayRecord()
        {
            ...
            numASAPPriority.Value = objMaster.Current.Priority.ToInt();
            ...
            chkInActive.Checked = objMaster.Current.IsNonVatable.ToBool();
         //   numLead.Value = objMaster.Current.IncrementRate.ToInt();
        ...
        public override void Save()
        {
            try
            {
                ...
                objMaster.Current.Priority = numASAPPriority.Value.ToInt();
             ...
             //   objMaster.Current.IncrementRate = numLead.Value;
              ...
              //  objMaster.Current.EnablePeakOffPeak = chkEnablePeakFares.Checked;
                ...
                objMaster.Current.IsNonVatable = chkInActive.Checked;
