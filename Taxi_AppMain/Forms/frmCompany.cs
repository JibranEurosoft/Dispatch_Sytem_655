...
namespace Taxi_AppMain
{
    public partial class frmCompany : UI.SetupBase
    {
        ...
        public struct COLS_COMPANYCODE
        {
            public static string Id = "Id";
            public static string MasterId = "MasterId";
        ...
        private void InitializeConstructor()
        {
            ...
            grdCompanyCode.CommandCellClick += GrdCompanyCode_CommandCellClick;
        ...
        private void GrdCompanyCode_CommandCellClick(object sender, EventArgs e)
        {
            if (grdCompanyCode.CurrentRow != null && grdCompanyCode.CurrentRow is GridViewDataRowInfo)
            {

                grdCompanyCode.CurrentRow.Delete();
        ...
        void grdContacts_RowsChanging(object sender, GridViewCollectionChangingEventArgs e)
        {
            if (e.Action == Telerik.WinControls.Data.NotifyCollectionChangedAction.Remove)
            {
                if (grdContacts.CurrentRow is GridViewDataRowInfo == false) return;
                ...
                try
                {
                    ...
                    if (objCC.Current != null)
                    {
                        ...
                        using (TaxiDataContext db = new TaxiDataContext())
                        {
                            db.ExecuteQuery<int>("exec stp_DeleteAccountContactDetails {0},{1},{2}", Id, 0, 0);
                        }
                    }
                    else
                    {
        ...
        private void FormatCompanyCodeGrid()
        {
            GridViewTextBoxColumn col = new GridViewTextBoxColumn();
            col.Name = COLS_COMPANYCODE .Id;
            col.IsVisible = false;
            grdCompanyCode.Columns.Add(col);

            col = new GridViewTextBoxColumn();
            col.Name = COLS_COMPANYCODE.MasterId;
            col.IsVisible = false;
            grdCompanyCode.Columns.Add(col);


            col = new GridViewTextBoxColumn();
            col.Name = COLS_COMPANYCODE.CompanyCode;
            col.HeaderText = "Company Code";
            col.Width = 250;
            grdCompanyCode.Columns.Add(col);
            col.ReadOnly = false;
            ...
            grdCompanyCode.AllowEditRow = true;
            grdCompanyCode.AllowAddNewRow = true;
            grdCompanyCode.AllowDeleteRow = true;
            grdCompanyCode.AddDeleteColumn();
            grdCompanyCode.AddNewRowPosition = SystemRowPosition.Top;
            grdCompanyCode.ShowRowHeaderColumn = false;

            grdCompanyCode.Columns["btnDelete"].Width = 100;
        ...
        void frmCompany_Shown(object sender, EventArgs e)
        {
            try
            {
                ...
                button1.Visible = System.Diagnostics.Debugger.IsAttached;
        ...
        public override void DisplayRecord()
        {
            ...
            if(objMaster.Current.SysGenId.ToInt()==10)
            {
            ...
            var itemX=ddlAdminFeeType.Items.FirstOrDefault(c => c.Text == objMaster.Current.AdminFeeType.ToStr());

            ddlAdminFeeType.SelectedItem = itemX;
            ...
            try
            {
                using (TaxiDataContext db = new TaxiDataContext())
                {
                    decimal companyPrice = db.ExecuteQuery<decimal>("Select CompanyPrice From Gen_Company Where Id=" + objMaster.PrimaryKeyValue.ToInt()).FirstOrDefault().DefaultIfEmpty();
                    if (companyPrice > 0)
                    {
                        numCompanyPricePercent.Value = companyPrice;
                    }
                }
       ...
       //     chkActivateLogin.Checked = objMaster.Current.IsWebLoginActive.ToBool();
          ...
          //  chkHasRoomCharge.Checked = objMaster.Current.HasRoomCharge.ToBool();
            ...
            chkEnableCompanyFaresForController.Checked = objMaster.Current.DisableCompanyFaresForController.ToBool();

            chkMandatoryDepartment.Checked = objMaster.Current.HasDepartment.ToBool();
            ...
            txtSpecialRequirements.Text = objMaster.Current.SpecialNotes.ToStr().Trim();
            ...
            ddlVehicleType.SelectedValue = objMaster.Current.DefaultVehicleId.ToInt();

            ddlSubCompany.SelectedValue = objMaster.Current.SubCompanyId.ToInt();

            chkNoCommission.Checked = objMaster.Current.DayAndNightWise.ToBool();
            ...
            chkHideBankDetails.Checked= objMaster.Current.HideBankDetails.ToBool();
            txtInvoiceNote.Text= objMaster.Current.NoteForInvoice.ToStr().Trim();
            txtInvoiceName.Text = objMaster.Current.WebLoginId.ToStr();
            ...
            foreach (var item in objMaster.Current.Gen_Company_CompanyCodes)
            {
                row = grdCompanyCode.Rows.AddNew();

                row.Cells[COLS_COMPANYCODE.Id].Value = item.Id;
                row.Cells[COLS_COMPANYCODE.MasterId].Value = item.CompanyId;
                row.Cells[COLS_COMPANYCODE.CompanyCode].Value = item.CompanyCode;
            }
        ...
        private void ClearCompanyCode()
        {
            grdCompanyCode.Rows.Clear();
        ...
        public override void OnNew()
        {
            ...
            chkHideBankDetails.Checked = false;
            txtInvoiceName.Text = string.Empty;
            txtInvoiceNote.Text = string.Empty;
        ...
        public bool OnSave()
        {
            try
            {
                ...
                if (chkMandatoryDepartment.Checked && grdDepartment.Rows.Count==0)
                {
                    ENUtils.ShowMessage("Required : Department");
                    return false;
                ...
                objMaster.Current.DayAndNightWise = chkNoCommission.Checked;
                ...
                objMaster.Current.DefaultVehicleId = ddlVehicleType.SelectedValue.ToIntorNull();

                objMaster.Current.SpecialNotes = txtSpecialRequirements.Text.Trim();
            ...
            //    objMaster.Current.WebLoginId = txtLoginID.Text.Trim();
             //   objMaster.Current.WebLoginPassword = txtPassword.Text.Trim();
              ...
              //  objMaster.Current.HasRoomCharge = chkHasRoomCharge.Checked;
                ...
                objMaster.Current.DisableCompanyFaresForController = chkEnableCompanyFaresForController.Checked;
                ...
                objMaster.Current.HasDepartment = chkMandatoryDepartment.Checked;
                ...
                objMaster.Current.HideBankDetails = chkHideBankDetails.Checked;
                objMaster.Current.NoteForInvoice = txtInvoiceNote.Text.Trim();
                objMaster.Current.WebLoginId = txtInvoiceName.Text.Trim();
                ...
                IList<Gen_Company_CompanyCode> savedListCompanyCode = objMaster.Current.Gen_Company_CompanyCodes;
                List<Gen_Company_CompanyCode> listofCompanyCode = (from r in grdCompanyCode.Rows
                                                              select new Gen_Company_CompanyCode
                                                              {
                                                                  Id = r.Cells[COLS_COMPANYCODE.Id].Value.ToInt(),
                                                                  CompanyCode = r.Cells[COLS_COMPANYCODE.CompanyCode].Value.ToStr().Trim(),
                                                                  CompanyId = r.Cells[COLS_COMPANYCODE.MasterId].Value.ToInt()

                                                              }).ToList();


                Utils.General.SyncChildCollection(ref savedListCompanyCode, ref listofCompanyCode, "Id", skipProperties);
                ...
                {
                    using (TaxiDataContext db = new TaxiDataContext()) {
                        db.stp_RunProcedure("Update Gen_Company Set CompanyPrice =" + numCompanyPricePercent.Value + " Where Id=" + objMaster.PrimaryKeyValue.ToInt());
                    }
            ...
            try
            {
                ...
                if (c != null)
                {
                 ...
                 //   txtPassword.Text = c.WebLoginPassword.ToStr();
                    ...
                    chkEnableCompanyFaresForController.Checked = c.DisableCompanyFaresForController.ToBool();
                  ...
                  //  chkActivateLogin.Checked = c.IsWebLoginActive.ToBool();
                    ...
                    foreach (var item in c.Gen_Company_CompanyCodes)
                    {
                        row = grdCompanyCode.Rows.AddNew();

                        row.Cells[COLS.Id].Value = item.Id;
                        row.Cells[COLS.MasterId].Value = item.CompanyId;
                        row.Cells["OrderNo"].Value = item.CompanyCode;
                    }
        ...
        private void radCompanyCode_Paint(object sender, PaintEventArgs e)
        {
        ...
        {
            rptfrmDriverShiftMapReport frm = new rptfrmDriverShiftMapReport();
            frm.Show();
