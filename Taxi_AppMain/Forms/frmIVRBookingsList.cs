...
{
    public partial class frmIVRBookingsList : UI.SetupBase
    {
         ...
         public frmIVRBookingsList()
        {
         ...
         void EditFareItem3_Click(object sender, EventArgs e)
         {
             ViewDetailForm();
         }
        ...
        void worker_DoWork(object sender, DoWorkEventArgs e)
        {
          ...
          //  exporter.Export(this.radGridView1, (String)e.Argument, "IVR Bookings");
        }
