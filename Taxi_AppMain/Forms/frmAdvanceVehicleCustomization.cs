...
{
    public partial class frmAdvanceVehicleCustomization : RadForm
    {
        public struct COLS
        {
        ...
        public frmAdvanceVehicleCustomization(long id)
        {
            InitializeComponent();
             ...
             //   optDaily.ToggleState = ToggleState.On;
              ...
              //  FormatPickupsGrid(grdPickupDates);
               // FormatPickupsGrid(grdExcludePickupDates);
                ...
                //        ddlFromLocType.SelectedIndexChanged+=       (ddlFromLocType_SelectedIndexChanged);  
        ...
        private void ApplyChanges()
        {
            ...
            //    GridViewRowInfo row = null;
                ...
                else if (chkStartingAt.Checked == false && chkEndingAt.Checked == true)
                {
                    ...
                    foreach (var gRow in grdBookings.Rows.Where(c => c.Cells[COLS.EXCLUDED].Value.ToStr() == "" && c.Cells[COLS.PickupDate].Value.ToDate() >= startingAt || c.Cells[COLS.PickupDate].Value.ToDate() <= startingAt))
                    {

                        if (chkPickupTime.Enabled && dtpPickupTime.Value != null)
                        {
                            //gRow.Cells[COLS.PickupDate].Value = gRow.Cells[COLS.PickupDate].Value.ToDate() + dtpPickupTime.Value.Value.TimeOfDay;
                            gRow.Cells[COLS.PickupDate].Value = dtpStartingAt.Value.Value.ToDate() + dtpPickupTime.Value.Value.TimeOfDay;
                        }
                    ...
                    else if (aTxt.SelectedItem != null && aTxt.SelectedItem.ToLower() == aTxt.Text.ToLower())
                    {
                        ...
                        if (loctypeId != 0)
                        {
                            ...
                            if (aTxt.Name == "txtFromAddress")
                            {
                                ...
                                RadListDataItem item = (RadListDataItem)ddlFromLocation.Items.FirstOrDefault(b => b.Text.Equals(aTxt.SelectedItem));
                                if (item != null)
                                {
                            ...
                            else if (aTxt.Name == "txtToAddress")
                            {
                                ...
                                RadListDataItem item = (RadListDataItem)ddlToLocation.Items.FirstOrDefault(b => b.Text.Equals(aTxt.SelectedItem));
                                if (item != null)
                                {
