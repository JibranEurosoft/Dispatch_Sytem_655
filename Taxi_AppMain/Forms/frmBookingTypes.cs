...
namespace Taxi_AppMain
{
    public partial class frmBookingTypes : UI.SetupBase
    {
        public struct COLS
        {
            ...
            public static string ASAPPriority = "ASAPPriority";
            public static string PreBookPriority = "PreBookPriority";
        ...
        public void FormatGrid()
        {
            ...
            colD.Name = COLS.ASAPPriority;
            colD.ReadOnly = false;
            colD.HeaderText = "ASAP";
            colD.DecimalPlaces = 0;
            colD.Minimum = 0;
            colD.Maximum = 9;
            colD.Width = 50;
            grdBookingType.Columns.Add(colD);

            colD = new GridViewDecimalColumn();
            colD.Name = COLS.PreBookPriority;
            colD.ReadOnly = false;
            colD.HeaderText = "PREBOOK";
            colD.Width = 65;
            colD.Minimum = 0;
            colD.Maximum = 9;
            colD.DecimalPlaces = 0;
        ...
        public override void PopulateData()
        {
            try
            {
                var data1 = General.GetQueryable<BookingType>(c => c.BookingTypeName != "").ToList();
               ...
               //    grdBookingType.Rows[i].Cells[COLS.BackgroundColor].Value = data1[i].BackgroundColor;
                    ...
                    grdBookingType.Rows[i].Cells[COLS.ASAPPriority].Value = data1[i].Priority;
                    grdBookingType.Rows[i].Cells[COLS.PreBookPriority].Value = data1[i].PreBookPriority;
                }
        ...
        public override void Save()
        {
            try
            {
                ...
                foreach (var item in grdBookingType.Rows)
                {
                    ...
                    objMaster.Current.Priority = item.Cells[COLS.ASAPPriority].Value.ToIntorNull();
                    objMaster.Current.PreBookPriority = item.Cells[COLS.PreBookPriority].Value.ToIntorNull();
                    objMaster.Save();
