...
{
    public partial class frmBlackCustomersList : UI.SetupBase
    {
         ...
         public frmBlackCustomersList()
        {
         ...
         void frmCustomersList_Shown(object sender, EventArgs e)
         {
           ...
           //  ddlColumns.Text = "Name";
            ...
            this.grdLister.MasterTemplate.ShowFilterCellOperatorText = false;
            ...
            try
            {
                ...
                using (TaxiDataContext db = new TaxiDataContext())
                {
                    ...
                    var query =( from a in db.Customers
                                where a.BlackList!=null && a.BlackList==true
                    ...
                    lblTotal.Text = "Total Customers : " + query.Count.ToStr();
        ...
        public  void PopulateDataByAddress()
        {
            try
            {
                ...
                using (TaxiDataContext db = new TaxiDataContext())
                {
                    ...
                    var customerIds = db.WhiteListAddresses.Where(c => c.CustomerId != null).Select(c => c.CustomerId).Distinct().ToList();
                                       
                    var query = (from a in db.Customers

                                 where
                                 a.BlackList!=null && a.BlackList==true
                    ...
                    query.RemoveAll(a=>customerIds.Count(c => c == a.Id) == 0);
