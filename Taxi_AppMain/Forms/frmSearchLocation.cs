    ...
    public partial class frmSearchLocation : Form
    {
        ...
        private void SelectLocation()
        {
            ...
            if (Lat != 0)
            {
                ...
                try
                {
                    ...
                    if (locationName.ToStr() != locationAddress.ToStr())
                    {
                        if (locationAddress.ToStr().ToUpper().StartsWith(locationName.ToStr().ToUpper()) == false)
                        {
                    ...
                    if (objMaster.Current.LocationName.ToStr().Contains(objMaster.Current.PostCode) && objMaster.Current.PostCode.ToStr().Trim().Length > 0)
                    {
                        ...
                        if (objMaster.Current.LocationName.ToStr().Trim().Length == 0)
                        {
                            objMaster.Current.LocationName = objMaster.Current.Address.ToStr().Trim();


                            if (objMaster.Current.LocationName.ToStr().Contains(objMaster.Current.PostCode))
                                SelectedLocation = objMaster.Current.LocationName;
        ...
        private void SearchLocation()
        {
            try
            {
                ...
                if(chkWithinRadius.Checked || chkCountry.Checked)
                ...
                if (chkIncludeIreland.Checked && chkIncludeIreland.Visible)
                {

                    baseCoordinates.Latitude = 53.350140;
                    baseCoordinates.Longtiude = -6.266155;
                }
        ...
        void frmLocationLatLong_Load(object sender, EventArgs e)
        {
            ...
            if(General.GetPostCodeMatch( AppVars.objPolicyConfiguration.BaseAddress.ToStr()).StartsWith("BT"))
            {
                chkIncludeIreland.Visible = true;
        ...
        private void chkIncludeIreland_CheckedChanged(object sender, EventArgs e)
        {
            if (chkIncludeIreland.Checked)
            {
                txtRadius.Maximum = 200;
                txtRadius.Value = 200;
               
            }
            else
            {
                txtRadius.Maximum = 30;
                txtRadius.Value = 10;
            }
            SearchLocation();
        }
        ...
        private void chkCountry_CheckedChanged(object sender, EventArgs e)
        {
            if (chkCountry.Checked)
            {
                chkWithinRadius.Checked = false;
            }
            else
            {
                chkWithinRadius.Checked = true;
            }
        }
    }
}
