    ...
    public partial class frmBookingsList : UI.SetupBase
    {
       ...
       // RadGridViewExcelExporter exporter = null;
        ...
        void frmBookingsList_Shown(object sender, EventArgs e)
        {
            try
            {
                ...
                if (AppVars.listUserRights.Count(c => c.functionId == "DELETE BOOKING") > 0)
                {
                ...
                GridMethods.SetFilter(grdLister, Telerik.WinControls.Data.FilterOperator.Contains,"Driver");
                ...
                grdLister.Columns["AccountFare"].Width = 70;
                ...
                if (AppVars.listUserRights.Count(c =>  c.functionId == "HIDE ACCOUNT FARES") > 0)
                {
                    ...
                    grdLister.Columns["AccountFare"].IsVisible = false;
                  

                    grdLister.Columns["CustomerFare"].IsVisible = false;
                ...
                if (hiddenColumnsList.Count(c => c.GridColumnName == "PaymentComments" && c.IsVisible == true) > 0)
                {
                    grdLister.Columns["PaymentComments"].Width = 70;

                    grdLister.Columns["PaymentComments"].HeaderText = "Pay Ref";
                }
                else
                    grdLister.Columns["PaymentComments"].IsVisible = false;
            ...
            try
            {
                ...
                if (this.IsFind)
                {
                    ...
                    skip = 0;
                        ...
                        if (OPTASC.Checked )
                            query = query.OrderBy(c => c.PickupDate).ToList();
            ...
            try
            {
                ...
                else if (cell.GridControl.Name == "grdLister")
                {
                    ...
                    if (EditFare == null)
                    {
                        ...
                        if (AppVars.listUserRights.Count(c => c.formName == "frmBookingsList" && c.functionId == "ALLOW CHANGE DRIVER ON COMPLETED JOBS") > 0)
                        {

                            RadMenuItem changeDriver = new RadMenuItem("Change Driver");
                            changeDriver.ForeColor = Color.Black;
                            changeDriver.BackColor = Color.Orange;
                            changeDriver.Name = "ChangeDriver";
                            changeDriver.Font = new Font("Tahoma", 10, FontStyle.Bold);
                            changeDriver.Click += new EventHandler(ChangeDriver_Click);
                            changeDriver.Visibility = ElementVisibility.Visible;
                            EditFare.Items.Add(changeDriver);
                        }
                    }
        ...
        void ChangeDriver_Click(object sender, EventArgs e)
        {
            try
            {
                long jobId = 0;
                ...
                if (jobId > 0)
                {
                    ...
                    frmChangeDriver frm=new frmChangeDriver(jobId,1);
        ...
        private void grid_CommandCellClick(object sender, EventArgs e)
        {
            try
            {
                 ...
                 if (name == "btnrecall")
                {
                    ...
                    if (AppVars.listUserRights.Count(c => c.functionId == "FORCE RECALL JOB") == 0)
                    {
                ...
                using (TaxiDataContext db = new TaxiDataContext())
                {
                    ...
                    if (this.IsFind)
                    {
                        ...
                        if (fromDate != null && toDate == null)
                        {
                            ...
                            MessageBox.Show("Required : till Date");
                            return;
                        }
                        ...
                        if (fromDate == null && toDate != null)
                        {
                            ...
                            MessageBox.Show("Required : From Date");
                            return;
                        }
       ...
       ExportToExcelML export = null;
        ...
        private void dtpFromDate_Opened(object sender, EventArgs e)
        {
            ...
            dtpFromDate.Tag = dtpFromDate.Value.Value.TimeOfDay;
        ...
        private void DtpToDate_Opened(object sender, EventArgs e)
        {
            ...
            dtpToDate.Tag = dtpToDate.Value.Value.TimeOfDay;
