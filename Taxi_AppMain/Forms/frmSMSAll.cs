    ...
    public partial class frmSMSAll : Forms.BaseForm
    {
        ...
        void item_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    Taxi_AppMain.frmCustomerLister frm = new Taxi_AppMain.frmCustomerLister();

                    frm.ShowDialog();
                    
                    List<object[]> obj = frm.ListofData;

                    if (obj != null)
                    {
                        string text = string.Join(",", obj.Select(c => c[2].ToString()).ToArray<string>());
