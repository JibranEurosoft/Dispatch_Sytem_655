...
namespace Taxi_AppMain
{
    public partial class frmrptJobRouthPathGoogle : Form
    {
            ...
            try
            {
                ...
                using (TaxiDataContext db = new TaxiDataContext())
                {
                   ...
                   //     }
                        ...
                        //   marker1.ToolTipText = "START at : " + string.Format("{0:HH:mm:ss}", acceptDateTime);
                ...
                if (cooddt != null)
                {
                    ...
                    else
                    {
                        ...
                        try
                        {
                            ...
                            //this.ObjBooking.AcceptedDateTime.ToDateTime()

                            //objset.FromDate.ToDateTime()
                            ...
                            //this.ObjBooking.AcceptedDateTime
                            ...
                            //ObjBooking.ClearedDateTime//l
                            if (dtto.ToDateTime() == null)
                            {
                                /*
                                //ObjBooking.STCDateTime
                                if (objset.UpdateDate.ToDateTime() == null)
                                {   //ObjBooking.POBDateTime
                                    if (objset.UpdateDate.ToDateTime() == null)
                                    {    //ObjBooking.ArrivalDateTime
                                        if (objset.UpdateDate.ToDateTime() == null)
                                        {   //this.ObjBooking.AcceptedDateTime
                                            trackBar1.Maximum = objset.UpdateDate.ToDateTime().TimeOfDay.TotalSeconds.ToInt();
                                            //this.ObjBooking.AcceptedDateTime
                                            lblEnd.Text = "(" + objset.UpdateDate.ToDateTime().ToDateTime().ToString("HH:mm") + ")";
                                        }
                                        else
                                        {
                                            // this.ObjBooking.ArrivalDateTime
                                            trackBar1.Maximum = objset.UpdateDate.ToDateTime().TimeOfDay.TotalSeconds.ToInt();
                                            //this.ObjBooking.ArrivalDateTime
                                            lblEnd.Text = "(" + objset.UpdateDate.ToDateTime().ToString("HH:mm") + ")";
                                        }
                                    }
                                    else
                                    {
                                        // this.ObjBooking.POBDateTime
                                        trackBar1.Maximum = objset.UpdateDate.ToDateTime().TimeOfDay.TotalSeconds.ToInt();
                                        //this.ObjBooking.POBDateTime.ToDateTime()
                                        lblEnd.Text = "(" + objset.UpdateDate.ToDateTime().ToString("HH:mm") + ")";
                                    }
                                }
                                else
                                {   //objset.Datefrom.ToDateTime()
                                    trackBar1.Maximum = objset.UpdateDate.ToDateTime().TimeOfDay.TotalSeconds.ToInt();

                                    //this.ObjBooking.STCDateTime
                                    lblEnd.Text = "(" + objset.UpdateDate.ToDateTime().ToString("HH:mm") + ")";
                                }
                            ...
                            {     // this.ObjBooking.ClearedDateTime
                        ...
                        /*
                          ...
                          row.Cells["Accepted"].Value = string.Format("{0:dd/MM HH:mm:ss}", ObjBooking.AcceptedDateTime);
                          row.Cells["Arrived"].Value = string.Format("{0:dd/MM HH:mm:ss}", ObjBooking.ArrivalDateTime);
                          row.Cells["POB"].Value = string.Format("{0:dd/MM HH:mm:ss}", ObjBooking.POBDateTime);
                          row.Cells["STC"].Value = string.Format("{0:dd/MM HH:mm:ss}", ObjBooking.STCDateTime);
                          row.Cells["Cleared"].Value = string.Format("{0:dd/MM HH:mm:ss}", ObjBooking.ClearedDateTime);
        ...
        //List<PointLatLng> listOfLocations
            ...
            try
            {
                ...
                if (acceptDateTime != null)
                {
                    ...
                    if (objacc != null)
                    {
                        ...
                        //below is move able marker
                        marker14 = new GMapMarkerCustom(new PointLatLng(Convert.ToDouble(objacc.Lat), Convert.ToDouble(objacc.Lng)), null);
                        marker14.ToolTipText = "Shift Start At : " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", acceptDateTime);
                        ...
                        //-------------end move able marker
                        
                        //-----------new marker to show initial position

                        marker15= new GMapMarkerCustom(new PointLatLng(Convert.ToDouble(objacc.Lat), Convert.ToDouble(objacc.Lng)), null);
                        marker15.ToolTipText = "Shift Start At : " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", acceptDateTime);
                        ...
                        //-----------end new marker to show initial position
                ...
                if (clearedDateTime != null)
                {
                    ...
                    if (objld != null)
                    {
                        ...
                        marker7.ToolTipText = "Shift Finish At : " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", clearedDateTime);
                        marker7.Tag = "8";
                        ...
                        else
                        {
                            if (stop == true)
                            {
                                ...
                                if (CheckTag == "visited")
                                {
                                    ...
                                    //marker14.ToolTipText = "Shift Start At : " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", pointsAndDates[0].UpdateDate);
                                    //marker14.ToolTipMode = MarkerTooltipMode.Always;
                                ...
                                //below is previous origional code
                                //marker14.MarkerImage = Taxi_AppMain.Properties.Resources.diamond_OnRoute;
                                //marker14.ToolTipText = "Driver  :" + driver + " No:" + driverno.ToStr() + refno + zonename + Environment.NewLine + "Speed : " + pointsAndDates[i].Speed.ToStr() + " mph" + Environment.NewLine + "Date Time : " + string.Format("{0:dd/MMM/yy HH:mm:ss}", pointsAndDates[i].UpdateDate);
                                //marker14.ToolTipMode = MarkerTooltipMode.Always;
                                //marker14.ToolTip.Font = f;
                                //marker14.MarkerImage = bmp;
                            ...
                            if (stop == false)
                            {
                                ...
                                {
                                    //queryData2[i].UpdateDate.Value >= stcDateTime.Value || queryData2[i].UpdateDate.Value.AddSeconds(30) > stcDateTime.Value
                                ...
                                {
                                    //queryData2[i].UpdateDate.Value >= pobDateTime.Value || queryData2[i].UpdateDate.Value.AddSeconds(30) > pobDateTime.Value
                                ...
                                {   //queryData[i].UpdateDate.Value >= arriveDateTime.Value || queryData2[i].UpdateDate.Value.AddSeconds(10) > arriveDateTime.Value
                                ...
                                */
                                ...
                                /*Below Method Added by Noshad to autoscrol with play button*/
                                //EnableTrackBar();
                                //PlayTrackBarAuto();
                                ...
                                //else
                                //{
                                    System.Threading.Thread.Sleep(speedAnimation);
                           //     }
            ...
            for (int i = startFrom; i < pointsAndDates.Count; i++)
            {
                ...
                else
                {
                    ...
                    if (stop == false)
                    {
                        ...
                        if (isTrue == false && _arriveDateTime != null)
                        {
                            //|| pointsAndDates[i].UpdateDate.AddSeconds(10) > _arriveDateTime.Value                            //10 0r 75            
                        ...
                        if (_stcDateTime != null)
                        {
                            ...
                            if (pointsAndDates[i].UpdateDate >= _stcDateTime.Value || pointsAndDates[i].UpdateDate.AddSeconds(25) > _stcDateTime.Value)
                            {
                                isTrue = true;
                        ...
                        if (clearedDateTime != null)
                        {
                            //if (i == queryData2.Count || queryData2[i].UpdateDate.Value >= clearedDateTime.Value || queryData2[i].UpdateDate.Value.AddSeconds(15) > clearedDateTime.Value)
                            //{
                            //i == pointsAndDates.Count ||

                            if (pointsAndDates[i].UpdateDate >= clearedDateTime.Value || pointsAndDates[i].UpdateDate.AddSeconds(15) > clearedDateTime.Value)
                            {
                                ...
                                EnableTrackBar();
                                //below break is written by noshad intentially
                                break;
                            }
                        }
            ...
            try
            {
...

                {
                    using (TaxiDataContext db = new TaxiDataContext())
                    {
                        ...
                        zonelist = db.Gen_Zones.Where(c => c.MaxLatitude != null).ToList();
                        driverName = db.Fleet_Drivers.Where(c => c.Id == this._DriverId).Select(c => c.DriverName).FirstOrDefault().ToStr();
            ...
            try
            {
                ...
                if (cooddt.Count > 0)
                {
                    ...
                    if (CheckTag!="visited") {
                        ...
                        marker14.ToolTipText = "Shift Start At : " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", cooddt[0].UpdateDate);
                        marker14.ToolTipMode = MarkerTooltipMode.Always;
                        marker14.ToolTip.Font = new Font("Tahoma", 8, FontStyle.Bold);
                    ...
                    else
                    {
                        ...
                        if (marker2== null)
                            marker2 = new GMapMarkerCustom(new PointLatLng(Convert.ToDouble(cooddt[accepteddateindex].Lat), Convert.ToDouble(cooddt[accepteddateindex].Lng)), null);
                        else
                            marker2.Position = new PointLatLng(Convert.ToDouble(cooddt[accepteddateindex].Lat), Convert.ToDouble(cooddt[accepteddateindex].Lng));

                        marker2.ToolTip.Font = new Font("Tahoma", 6, FontStyle.Bold);
                        marker2.MarkerImage = Taxi_AppMain.Properties.Resources.diamond_OnRoute;

                        marker2.ToolTipText = "Accepted at : " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", _acceptDateTime);
                        btnPauseNav.Text = "Pause";
                        pause = false;
                        this.gMapControl1.BeginInvoke((MethodInvoker)delegate ()
                        {
                            gMapControl1.Position = new PointLatLng(Convert.ToDouble(cooddt[accepteddateindex].Lat), Convert.ToDouble(cooddt[accepteddateindex].Lng));
        ...
        public void StopNavigationOnZoomChange()
        {
            try
            {
                ...
                if (cooddt.Count > 0)
                {
                    ...
                    marker14.ToolTipText = "START at : " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", cooddt[0].UpdateDate);
        ...
        public void PlayRecordingByTrackBar()
        {
            try
            {
                //ObjBooking.AcceptedDateTime
                //DateTime dt =objset.ToDateTime();
                //DateTime dtfrom = cooddt.l objset.ListOfUpdatedDate.FirstOrDefault();
                var lst = cooddt.FirstOrDefault();
                var last = cooddt.LastOrDefault();
          ...
          //  var lstdrivername = DriverList.Where(x => x.Id == Convert.ToInt32(_DriverId)).Select(c => c.DriverName).ToList();
            ...
            if (pointsAndDates.Count > 0)
            {
                ...
                if (CheckTag != "visited")
                {
                    ...
                    marker14.ToolTipText += Environment.NewLine + "Time : " + string.Format("{0:HH:mm:ss}", pointsAndDates[i].UpdateDate);
        ...
        public void ScrollBarWhenZoombtnSelected(List<CoordinatesWithUpdatedDate> pointsAndDates)
        {
            Font f = new Font("Tahoma", 8, FontStyle.Bold);
            ...
            if (marker2 == null)
            {                                                                                   
                marker2 = new GMapMarkerCustom(new PointLatLng(Convert.ToDouble(pointsAndDates[accepteddateindex].Lat), Convert.ToDouble(pointsAndDates[accepteddateindex].Lng)), null);
                polyOverlay.Markers.Add(marker2);
            }
            else
                marker2.Position = new PointLatLng(Convert.ToDouble(pointsAndDates[accepteddateindex].Lat), Convert.ToDouble(pointsAndDates[accepteddateindex].Lng));
        ...
        private void DrawPlotsOnMap(bool showPlots, int zoneId)
        {
            try
            {
                ...
                else
                {
                    ...
                    {
                        db.DeferredLoadingEnabled = false;
                        var listofPolyVertices = db.Gen_Zone_PolyVertices.ToList();
                        ...
                        foreach (var zone in zonelist)
                        {
                            ...
                            points = listofPolyVertices.Where(c=>c.ZoneId==zone.Id)
                            ...
                            if (points.Count > 0)
                            {
                                ...
                                //{
                                    ...
                                    polygon.Stroke = new Pen(Color.DarkGreen, 0.5f);
                                    polygon.Tag = zone.Id;
                              ...
                              //  }
                                ...
                                marker.Tag = zone.Id;
                                marker.MarkerText2 = zone.ZoneName.ToStr();
        ...
        private void grdLister_CommandCellClick(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (gridCell.ColumnInfo.Name.ToString() == "btnViewMap")
                {
                    ...
                    List<CoordinatesWithUpdatedDate> datalst = new List<CoordinatesWithUpdatedDate>();
                    ...
                    {
                        _acceptDateTime = cooddt[accepteddateindex].UpdateDate.ToDateTime();
                        ...
                        marker2.Tag = "2";
                        marker2.Position = new PointLatLng(Convert.ToDouble(cooddt[accepteddateindex].Lat), Convert.ToDouble(cooddt[accepteddateindex].Lng));
                        marker2.ToolTipText = "Accepted at : " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", acceptedate);
                        marker2.ToolTipMode = MarkerTooltipMode.Always;
                    ...
                    else
                    {
                        ...
                        marker6.ToolTipText = "Destination at : " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", arriveddate);
                    ...
                    */
                    ...
                    else
                    {
                        ...
                        //pickupindex
                        GMapMarkerCustom marker1 = new GMapMarkerCustom(new PointLatLng(Convert.ToDouble(cooddt[arriveddateindex].Lat), Convert.ToDouble(cooddt[arriveddateindex].Lng)), null);


                        marker1.Tag = "1";                                       //pickupindex                              //pickupindex
                        marker1.Position = new PointLatLng(Convert.ToDouble(cooddt[arriveddateindex].Lat), Convert.ToDouble(cooddt[arriveddateindex].Lng));

                        //picupdate was replaced with arrieveddate
                        marker1.ToolTipText = "Arrived at : " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", arriveddate);
                        ...
                        gMapControl1.Position = new PointLatLng(Convert.ToDouble(cooddt[arriveddateindex].Lat), Convert.ToDouble(cooddt[arriveddateindex].Lng));
                    ...
                    {
                        _pobDateTime = cooddt[pobdateindex].UpdateDate.ToDateTime();
                        ...
                        GMapMarkerCustom marker4 = new GMapMarkerCustom(new PointLatLng(Convert.ToDouble(cooddt[pobdateindex].Lat), Convert.ToDouble(cooddt[pobdateindex].Lng)), Resources.Resource1.pob);


                        marker4.Tag = "4";
                        marker4.Position = new PointLatLng(Convert.ToDouble(cooddt[pobdateindex].Lat), Convert.ToDouble(cooddt[pobdateindex].Lng));
                        marker4.ToolTipText = "POB at : " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", pobdate);
                    ...
                    else
                    {
                        ...
                        _stcDateTime = cooddt[stcddateindex].UpdateDate.ToDateTime();
                        ...
                        GMapMarkerCustom marker5 = new GMapMarkerCustom(new PointLatLng(Convert.ToDouble(cooddt[stcddateindex].Lat), Convert.ToDouble(cooddt[stcddateindex].Lng)), Resources.Resource1.stc);
                        marker5.Position = new PointLatLng(Convert.ToDouble(cooddt[stcddateindex].Lat), Convert.ToDouble(cooddt[stcddateindex].Lng));
                        marker5.ToolTipText = "STC at : " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", stcdate);
                    ...
                    {
                        _clearedDateTime = cooddt[clearddateindex].UpdateDate.ToDateTime();
                        ...
                        GMapMarkerCustom marker3 = new GMapMarkerCustom(new PointLatLng(Convert.ToDouble(cooddt[clearddateindex].Lat), Convert.ToDouble(cooddt[clearddateindex].Lng)), Resources.Resource1.clear);

                        //}
                        //else
                        marker3.Tag = "3";
                        marker3.Position = new PointLatLng(Convert.ToDouble(cooddt[clearddateindex].Lat), Convert.ToDouble(cooddt[clearddateindex].Lng));
                        marker3.ToolTipText = "Cleared at : " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", cleareddate);
                ...
                {                 
                    ...
                    */
                    ...
                    if (pickupindex != -1)
                    {
                        ...
                        marker1.ToolTipText = "Arrived at : " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", picupdate);
