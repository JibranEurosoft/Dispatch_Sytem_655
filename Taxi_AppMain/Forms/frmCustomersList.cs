...
namespace Taxi_AppMain
{
    public partial class frmCustomersList : UI.SetupBase
    {
        ...
        void frmCustomersList_Shown(object sender, EventArgs e)
        {
           ...
           grdLister.Columns["ExcludedDriverIds"].IsVisible = false;

            grdLister.Columns["LikesAndDislikes"].IsVisible = false;
            ...
            var list = AppVars.listUserRights.ToList();
                    ...
                    if (gridCell.ColumnInfo.Name.ToLower() == "btncreatebooking")
                    {
                        ...
                        else
                        {
                            ...
                            General.ShowBookingForm(0, false, row.Cells["Name"].Value.ToStr(), phone, mobileNo,
                                                             row.Cells["DoorNo"].Value.ToStr(), row.Cells["Address"].Value.ToStr(),email,row.Cells["ExcludedDriverIds"].Value.ToStr(), row.Cells["LikesAndDislikes"].Value.ToStr());
     ...
     //   RadGridViewExcelExporter exporter = null;
        private void btnExport_Click(object sender, EventArgs e)
        {
            ...
            if (DialogResult.OK == saveFileDialog1.ShowDialog())
            {
                ...
                export.HiddenRowOption = HiddenOption.ExportAsHidden;
