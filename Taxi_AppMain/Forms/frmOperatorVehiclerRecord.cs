...
{
    public partial class frmOperatorVehiclerRecord : UI.SetupBase
    {
        //RadGridViewExcelExporter exporter = null;
        public frmOperatorVehiclerRecord()
        {
            InitializeComponent();
        ...
        void worker_DoWork(object sender, DoWorkEventArgs e)
        {
           ...
           // exporter.Export(this.radGridView1, (String)e.Argument, "Operator Vehicler");
        }
