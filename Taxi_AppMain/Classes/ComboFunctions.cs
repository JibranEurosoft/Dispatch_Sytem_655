...
namespace Taxi_AppMain
{
   public  class ComboFunctions
    ...
    {
        public static void FillEscortTrainingDocumentTypeCombo(RadDropDownList dropDown)
        {
            ComboFunctions.FillCombo<Gen_Syspolicy_TrainingDocumentList>
             (AppVars.BLData.GetAll<Gen_Syspolicy_TrainingDocumentList>().Where(c => c.TrainingFor == 2).ToList(), dropDown, "DocumentName", "Id");
        }

        public static void FillLocTypeCombo(RadDropDownList dropDown)
        {

            ComboFunctions.FillCombo<Gen_LocationType>
             (AppVars.BLData.GetAll<Gen_LocationType>(c => c.ShortCutKey != null).OrderBy(c => c.LocationType).ToList(), dropDown, "LocationType", "Id");
        ...
        public static void FillEscortCombo1(RadDropDownList dropDown)
        {
            using (TaxiDataContext db = new TaxiDataContext())
            {
                ComboFunctions.FillCombo
              (db.GetTable<Gen_Escort>()
              .OrderBy(c => c.EscortName).Select(args => new { args.Id, args.EscortName }).ToList(), dropDown, "EscortName", "Id");
            }
        }
        public static void FillFullLocationsCombo(RadDropDownList dropDown)
        {

            ComboFunctions.FillCombo<Gen_Location>
             (AppVars.BLData.GetAll<Gen_Location>(c => c.FullLocationName != null).OrderBy(c => c.FullLocationName).ToList(), dropDown, "FullLocationName", "Id");
        }

        public static void FillNewLocationCombo(RadDropDownList dropDown)
        {
            try
            {
                using (TaxiDataContext db = new TaxiDataContext())
                {
                    var list = db.ExecuteQuery<Gen_NewLocations>("select Id , FullLocationName from Gen_NewLocations order by FullLocationName").Select(args => new
                    {
                        Id = args.Id,
                        FullLocationName = args.FullLocationName,

                    }).Distinct().ToList();


                    dropDown.DataSource = list;
                    dropDown.DisplayMember = "FullLocationName";
        ...
        public static void FillCompanyComboX(ComboBox dropDown)
        {
            ...
            try
            {
                ...
                using (TaxiDataContext db = new TaxiDataContext())
                {
                    ...
                    var list = db.GetTable<Gen_Company>().Where(c => c.IsClosed == false).OrderBy(c => c.CompanyName).Select(args => new { args.Id, CompanyName =args.CompanyCode!=""? args.CompanyCode + " - " + args.CompanyName:args.CompanyName, args.BackgroundColor, args.TextColor }).ToList();
                    ComboFunctions.FillCombo
                  (list, dropDown, "CompanyName", "Id");
       ...
       public static void FillDriverNoComboSorted(RadDropDownList dropDown, Expression<Func<Fleet_Driver, bool>> _condition)
       {
          

                var list = (from a in AppVars.BLData.GetQueryable<Fleet_Driver>(_condition).AsEnumerable().OrderBy(item => item.DriverNo, new NaturalSortComparer<string>())
        ...
        public static void FillDriverNoDetailComboSorted(RadDropDownList dropDown)
        {
       ...
       public static void FillSubCompanyNameCombo(RadDropDownList dropDown)
       {
           ...
           ComboFunctions.FillCombo
            (General.GetQueryable<Gen_SubCompany>(null).Select(args=>new{args.Id,args.CompanyName}).ToList(), dropDown, "CompanyName", "Id");
        ...
        public static void FillSubCompanyCombo(RadDropDownList dropDown)
        {
            ...
            ComboFunctions.FillCombo
             (General.GetQueryable<Gen_SubCompany>(null).Select(args => new { args.Id, args.CompanyName }).ToList(), dropDown, "CompanyName", "Id", false);
       ...
       public static void FillAccountTypeCombo(RadDropDownList dropDown)
       {
        ...
        public static void FillAccountTypeCombo(RadDropDownList dropDown, Expression<Func<AccountType, bool>> expression)
        {

            ComboFunctions.FillCombo<AccountType>
             (AppVars.BLData.GetAll<AccountType>(expression).ToList(), dropDown, "AccountTypeName", "Id");
       ...
       public static void FillUsersCombo(RadDropDownList dropDown)
       {
        ...
        public static void FillUsersCombo(RadDropDownList dropDown, Expression<Func<UM_User, bool>> expression)
        {

            ComboFunctions.FillCombo<UM_User>
             (AppVars.BLData.GetAll<UM_User>(expression).ToList(), dropDown, "UserName", "Id");
        ...
        public static void FillAvailablePaymentGatewayCombo(RadDropDownList dropDown)
       {
        ...
        public static void FillDispatchAvailablePaymentGatewayCombo(RadDropDownList dropDown, Expression<Func<Gen_SysPolicy_PaymentDetail, bool>> exp=null)
        {

            var list = (General.GetQueryable<Gen_SysPolicy_PaymentDetail>(exp)
       ...
       {
           var list = (from a in AppVars.BLData.GetQueryable<Gen_Zone>(c=>c.ZoneName!="SIN BIN")
                       orderby a.OrderNo
                       select new
                           {
                               Id = a.Id,
       ...
       //public static void FillCompanyCombo(RadDropDownList dropDown, int companyId)
       //{
       ...
       public static void FillCompanyForInvoiceCombo(ComboBox dropDown)
       {
            SuggestComboBox s = (SuggestComboBox)dropDown;
            ...
            using (TaxiDataContext db = new TaxiDataContext())
           {
                ...
                //    (c.Gen_Company_PaymentTypes.Count==0 || c.Gen_Company_PaymentTypes.Any(a=>a.PaymentTypeId==Enums.PAYMENT_TYPES.BANK_ACCOUNT || a.PaymentTypeId==7))).OrderBy(c => c.CompanyName).Select(args => new { args.Id, args.CompanyName }).ToList(), dropDown, "CompanyName", "Id");

                var list = db.GetTable<Gen_Company>().Where(c => c.IsClosed == false &&
                (c.Gen_Company_PaymentTypes.Count == 0 || (c.AccountTypeId==1 || c.AccountTypeId==3)))
                .OrderBy(c => c.CompanyName).Select(args => new { args.Id, CompanyName = args.AccountNo != "" ? args.AccountNo + " - " + args.CompanyName : args.CompanyName }).ToList();
                ComboFunctions.FillCombo
              (list, dropDown, "CompanyName", "Id");
       ...
       public static void FillCompanyForInvoiceCombo(ComboBox dropDown,int companyId)
       {
            ...
            using (TaxiDataContext db = new TaxiDataContext())
           {
                ...
                var list = db.GetTable<Gen_Company>().Where(c => c.IsClosed == false &&
                   (c.Gen_Company_PaymentTypes.Count == 0 || (c.AccountTypeId == 1 || c.AccountTypeId == 3)))
                   .OrderBy(c => c.CompanyName).Select(args => new { args.Id, CompanyName = args.AccountNo + " - " + args.CompanyName }).ToList();
                ComboFunctions.FillCombo
              (list, dropDown, "CompanyName", "Id");
       ...
       public static void FillCompanyCombo(RadDropDownList dropDown,bool excludeInActive=false)
       {
        ...
        public static void FillCombo(DataTable dt, ComboBox dropdown, string DisplayMember, string ValueMember)
        {
            try
            {
                dropdown.DataSource = null;
       ...
       public static void FillAttributeCombo(RadDropDownList dropdown)
       {
        ...
        public static void FillAttributeAndVehicleCombo(RadDropDownList dropdown)
        {
            ...
            using (TaxiDataContext db = new TaxiDataContext())
            {
                ...
                var list2 = (from a in General.GetQueryable<Fleet_VehicleType>(null)
                            orderby a.OrderNo
                            select new
                            {
                                ShortName =Convert.ToString(a.Id),
                                Name = a.VehicleType,
                                AttType = "VehicleAttributeType"
        ...
        public static void FillDriverNoCombo(RadDropDownList dropDown)
       {
            ...
            if (AppVars.objPolicyConfiguration.ShowAllJobsOrderNo.ToBool())
            {
                var list = (from a in AppVars.BLData.GetQueryable<Fleet_Driver>(c => c.IsActive == true)
                            ...
                            {
                                Id = a.Id,
                                DriverName =a.DisplayName==null? a.DriverNo + " - " + a.DriverName:a.DisplayName + " - " + a.DriverName + " "+a.Surname+ " [" + a.Fleet_VehicleType.VehicleType + "]",
                                VehicleDetails = a.VehicleNo + " - " + a.VehicleColor + " - " + a.VehicleMake
       ...
       {
           var list = (from a in General.GetQueryable<Fleet_DriverQueueList>(null)
                       where a.DriverId != null && a.Status == true && (a.Fleet_Driver.SubcompanyId == AppVars.DefaultDriverSubCompanyId || AppVars.DefaultDriverSubCompanyId == 0) 
                       && (a.ZoneId == null || a.ZoneId != null && a.Gen_Zone.ZoneName != "SIN BIN")
       ...
       public static void FillDriverNoCombo(RadDropDownList dropDown,Expression<Func<Fleet_Driver,bool>> _condition)
       {
            ...
            if (AppVars.objPolicyConfiguration.ShowAllJobsOrderNo.ToBool())
            {
                ...
                var list = (from a in General.GetQueryable<Fleet_DriverQueueList>(null)
                            ...
                            orderby a.Fleet_Driver.DisplayName
                            select new
                            {
                                Id = a.DriverId,
                                DriverName = (a.Fleet_Driver.DisplayName + " - " + a.Fleet_Driver.DriverName + " "+ a.Fleet_Driver.Surname + " [" + a.Fleet_Driver.Fleet_VehicleType.VehicleType + "]")
       ...
       public static void FillDriverNoQueueCombo(RadDropDownList dropDown)
       {
           ...
           if (AppVars.objPolicyConfiguration.DisableJobOfferToOnBreakDrv.ToBool())
           {
               var list = (from a in General.GetQueryable<Fleet_DriverQueueList>(null)
                           ...
                           select new
                           {
                               Id = a.DriverId,
                               DriverName = (a.Fleet_Driver.DriverNo + " - " + a.Fleet_Driver.DriverName + " [" + a.Fleet_Driver.Fleet_VehicleType.VehicleType + "]"),
                               VehicleDetails = a.Fleet_Driver.VehicleNo + " - " + a.Fleet_Driver.VehicleColor + " - " + a.Fleet_Driver.VehicleMake
                           }).Distinct().ToList();
        ...
        public static void FillDriverNoQueueDespatchComboIncSinbin(RadDropDownList dropDown)
        {
        ...
        public static void FillDriverNoFOJQueueCombo(RadDropDownList dropDown)
       {
        ...
        public static void FillDriverNoLoggedInDespatchQueueCombo(RadDropDownList dropDown,int? driverId=null,string driverNameNo="")
        {
            ...
            if (AppVars.objPolicyConfiguration.ShowAllJobsOrderNo.ToBool())
            {
                ...
                if (driverId != null && list.Count(c => c.Id == driverId) == 0)
                {
                    ...
                    list.Add(new { Id = driverId, DriverName = driverNameNo, VehicleDetails = "" });
            ...
            else
            {
                var list = (from a in General.GetQueryable<Fleet_DriverQueueList>(null)
                   ...
                   && (a.IsManualLogin == null || a.IsManualLogin == false)
                            ...
                            select new
                            {
                                ...
                                DriverName = (a.Fleet_Driver.DriverNo + " - " + a.Fleet_Driver.DriverName + " [" + a.Fleet_Driver.Fleet_VehicleType.VehicleType + "]"),
                                VehicleDetails = a.Fleet_Driver.VehicleNo + " - " + a.Fleet_Driver.VehicleColor + " - " + a.Fleet_Driver.VehicleMake,
                                DriverWorkStatusId= a.DriverWorkStatusId
                ...
                if (driverId != null && list.Count(c => c.Id == driverId) == 0)
                {
                    ...
                    list.Add(new { Id = driverId, DriverName = driverNameNo, VehicleDetails = "", DriverWorkStatusId=default(int?) });
            ...
            try
            {
                using (TaxiDataContext db = new TaxiDataContext())
                {
                    ...
                    var list = (from a in db.Fleet_Drivers
                                join b in db.Fleet_VehicleTypes on a.VehicleTypeId equals b.Id
                                where a.HasPDA == true && (a.IsActive != null && a.IsActive == true)
                                ...
                                select new
                                {
                                    Id = a.Id,
                                    DriverNo = a.DriverNo,
                                    DriverName = (a.DriverNo + " - " + a.DriverName + " [" + b.VehicleType + "]")
                                    //    DriverName = (a.Fleet_Driver.DriverNo + " - " + a.Fleet_Driver.DriverName ")
