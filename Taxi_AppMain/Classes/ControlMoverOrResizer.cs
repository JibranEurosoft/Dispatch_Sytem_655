    ...
    internal class ControlMoverOrResizer
    {
        ...
        private static void MoveControl(Control control, MouseEventArgs e)
        {
            ...
            if (_resizing)
            {
                ...
                if (MouseIsInLeftEdge && AppVars.objPolicyConfiguration.BookingFormType==2)
                {
                    if (MouseIsInTopEdge)
                    {
                    ...
                    else
                    {
                        ...
                        if ((control.Width > (control.Width - (e.X - _cursorStartPoint.X))) && control.Width < 20)
                            return;
                ...
                else if (MouseIsInRightEdge)
                {
                    ...
                    control.Width = (e.X) + _currentControlStartSize.Width;
                    //if (MouseIsInTopEdge)
                    //{
