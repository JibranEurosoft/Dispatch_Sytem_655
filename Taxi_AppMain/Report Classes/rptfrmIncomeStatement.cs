...
{
    public partial class rptfrmIncomeStatement : UI.SetupBase
    {
        bool IsReportLoaded = false;
        public rptfrmIncomeStatement()
        {
            InitializeComponent();
        ...
        public void ExportReport()
        {
            ...
            saveFileDlg.FileName = "Income Statement Report";
        ...
        {
            General.ShowEmailForm(reportViewer1, "Income Statement Report");
        }
