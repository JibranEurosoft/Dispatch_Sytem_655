    ...
    public partial class rptfrmJobDetails : UI.SetupBase
    {
        ...
        public void GenerateReport()
        {
            ...
            try
            {
                ...
                string hidebookingfee = "0";
                try
                {
                    using (TaxiDataContext db = new TaxiDataContext())
                    {
                       var fee = db.ExecuteQuery<string>("select SetVal from appsettings where setkey='hidebookingfeeonjobreceipt'").FirstOrDefault().ToBool();
                ...
                param[6] = new Microsoft.Reporting.WinForms.ReportParameter("BookingFee",this.DataSource[0].ServiceCharges.ToDecimal().ToStr());
                param[7] = new Microsoft.Reporting.WinForms.ReportParameter("hidebookingfee", hidebookingfee);
