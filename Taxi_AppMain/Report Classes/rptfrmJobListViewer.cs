...
namespace Taxi_AppMain
{
    public partial class rptfrmJobListViewer : UI.SetupBase
    {
        ...
        public List<stp_GetBookingBaseResultEx> DataSourceBySP { get; set; }
        ...
        {
            reportViewer1.ShowExportButton = AppVars.listUserRights.Count(c => c.functionId == "DISABLE EXPORT LIST") == 0;
