...
namespace Taxi_AppMain
{
    public partial class rptfrmJobDetails4 : UI.SetupBase
    {
        ...
        public void GenerateReport()
        {
          ...
          //      param[1] = new Microsoft.Reporting.WinForms.ReportParameter("Report_Parameter_CreditCardExtraCharges",SurchargeAmount.ToStr()); //AppVars.objPolicyConfiguration.CreditCardExtraCharges.ToStr());
                //Report_Parameter_CreditCardExtraCharges

             //   param[2] = new Microsoft.Reporting.WinForms.ReportParameter("Report_Parameter_CardNumber", cardNumber);

           //     param[1] = new Microsoft.Reporting.WinForms.ReportParameter("Report_Parameter_VatNumber", AppVars.objSubCompany.CompanyVatNumber.ToStr());
              //  param[9] = new Microsoft.Reporting.WinForms.ReportParameter("Report_Parameter_ShowSummary", ShowSummary);
            ...
            //    this.reportViewer1.SetDisplayMode(DisplayMode.);
        ...
        public void SendEmail(string bookingNo, string email)
        {
            ...
            General.ShowEmailForm(reportViewer1, "Booking Receipt " + bookingNo, email);
