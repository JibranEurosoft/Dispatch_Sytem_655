        ...
        public void LoadReport()
        {
            try
            {
                ...
                using (TaxiDataContext db = new TaxiDataContext())
                {
                    ...
                    {
                        List<stp_GetDriverEarningResult_Template3> list = db.ExecuteQuery<stp_GetDriverEarningResult_Template3>("exec stp_GetDriverEarning {0},{1},{2},{3},{4}", dtFrom, dtTill, ddlAllDriver.SelectedValue.ToInt(), Enums.BOOKINGSTATUS.DISPATCHED, 0).ToList();

                        this.reportViewer1.LocalReport.ReportEmbeddedResource = "Taxi_AppMain.ReportDesigns.Template3_rptDriverEarning.rdlc";
                        ...
                        var list2 =( from a in list
                                    select new
                                    {
                                        ...
                                        Cash = a.Cash,
                                        Commission = a.Commission,
                                        AvgJob = a.AvgJob, // a.PDARent,
                                        Avghour = a.Avghour, //  a.Parking + a.ExtraDropCharges,
                                        Avgday = a.Avgday,// ((a.Account - a.Commission).ToDecimal() + (a.Parking + a.ExtraDropCharges)) - a.PDARent,
                                        LoginDateTime = a.LoginDateTime,
                                        a.PDARent,
                                        a.Parking,
                                        a.Waiting,
                        ...
                        var list3 = (list.AsEnumerable().OrderBy(item => item.DriverNo, new NaturalSortComparer<string>())).ToList();
