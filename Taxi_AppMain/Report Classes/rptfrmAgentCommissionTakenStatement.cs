...
{
    public partial class rptfrmAgentCommissionTakenStatement : UI.SetupBase
    {
     ...
     //   private bool _ShowCharges = false;
        ...
        public rptfrmAgentCommissionTakenStatement()
        {
            InitializeComponent();
        ...
        public override void Print()
        {
            ...
            this.DataSource = GetDataSource(companyId,departmentId, fromDate, tillDate,GroupId) ;
            GenerateReport();        
        ...
        private void ReInitializeReportViewer()
        {
            ...
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "Taxi_AppMain.ReportDesigns.Template5_rptAgentCommissionStatementToCollect.rdlc";
        ...
        public void GenerateReport()
        {
            ...
            string telNo = "Tel No. " + objSubCompany.TelephoneNo;
                ...
                param = new Microsoft.Reporting.WinForms.ReportParameter[9];
                int GroupBy = 0;
            ...
            //param[12] = new Microsoft.Reporting.WinForms.ReportParameter("Report_Parameter_Header", AppVars.objSubCompany.CompanyName + " Agent Commission Report - To Collect");
            ...
            //if (chkShowCharges.Checked)
            //{
            //    this.reportViewer1.LocalReport.ReportEmbeddedResource = reportPath + "rptAgentCommissionTakenStatement.rdlc";
            //}
            //else
            //{
            this.reportViewer1.LocalReport.ReportEmbeddedResource = reportPath + "Template5_rptAgentCommissionStatementToCollect.rdlc";
            //}
         ...
         //   this.reportViewer1.LocalReport.DataSources.Add(imageDataSource);
            ...
            decimal OwnedjobsTotal = this.DataSource
              //  .Where(c => c.JobTakenByCompany.ToBool())
                .Sum(c => c.CompanyPrice.ToDecimal());


            decimal commissionTotal = this.DataSource.Sum(c => c.DriverCommission.ToDecimal());
        ...
        public void ExportReport()
        {
            ...
            saveFileDlg.FileName = "Agent Commission Report - To Collect";
        ...
        private List<Vu_BookingBase> GetDataSource(int companyId,int departmentId, DateTime? fromDate, DateTime? tillDate,int GroupId)
        {
            return General.GetQueryable<Vu_BookingBase>(c => (c.BookingStatusId == Enums.BOOKINGSTATUS.DISPATCHED || c.BookingStatusId == Enums.BOOKINGSTATUS.NOPICKUP) 
                                                   ...
                                                   //  && (c.PaymentTypeId == Enums.PAYMENT_TYPES.ROOM_CHARGE) 
                                                            &&(companyId==0 || c.CompanyId == companyId )
                                                            && (departmentId==0 || c.DepartmentId==departmentId)
                                                            &&(GroupId==0 || c.CompanyGroupId==GroupId)
                                                )
        ...
        public void SendEmail()
        {
            ...
            General.ShowEmailForm(reportViewer1, "Agent Commission Report - To Collect");
