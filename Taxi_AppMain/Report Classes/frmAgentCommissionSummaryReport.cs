...
{
    public partial class frmAgentCommissionSummaryReport: UI.SetupBase
    {
        ...
        public frmAgentCommissionSummaryReport()
        {
            InitializeComponent();
        ...
        public override void Print()
        {
         ...
         List<ClsAgentCommissionSummary> _DataSource;

        public List<ClsAgentCommissionSummary> DataSource
        {
        ...
        private void ReInitializeReportViewer()
        {
            ...
            //    return;
            reportViewer1.ShowExportButton = btnExportPDF.Visible;
            reportViewer1.Clear();
            ...
            reportDataSource3.Name = "Taxi_Model_ClsAgentCommissionSummary";
            ...
            //this.reportViewer1.LocalReport.ReportEmbeddedResource = "Taxi_AppMain.ReportDesigns.Template2_rptAgentCommissionSummaryStatement.rdlc";
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "Taxi_AppMain.ReportDesigns.Template2_rptAgentCommissionSummary.rdlc";
        ...
        public void GenerateReport()
        {
            ...
            //    string reportHeading = AppVars.objSubCompany.CompanyName + " Agent Commission Summary Report";
            ...
            //    //    param[12] = new Microsoft.Reporting.WinForms.ReportParameter("Report_Parameter_Header", AppVars.objSubCompany.CompanyName + " Agent Commission Summary Report");
            ...
            //        }
            //        else
            //           this.reportViewer1.LocalReport.ReportEmbeddedResource = reportPath + objTemplate.TemplateName.ToStr().Trim() + "_rptAgentCommissionSummaryStatement.rdlc";
            //    }
            //    else
            //    {
            //        if (objTemplate.TemplateName.ToStr() == "Template4")
            ...
            this.reportViewer1.LocalReport.ReportEmbeddedResource = reportPath + "Template2_rptAgentCommissionSummary.rdlc";
            //}
        ...
        private List<ClsAgentCommissionSummary> listofTempDataSource = new List<ClsAgentCommissionSummary>();
        ...
        public void ExportReport()
        {
            ...
            saveFileDlg.FileName = "Agent Commission Summary Report";
        ...
        private List<ClsAgentCommissionSummary> GetDataSource(int companyId, int departmentId, DateTime? fromDate, DateTime? tillDate, string BookedBy, int CompanyGroupId,int paymenttype)
        {
            ...
            //exec stp_AgentCommissionSummary '01-Jan-2000','01-Jan-2024',0
           
                //exec stp_AgentCommissionSummary '01-Jan-2000','01-Jan-2024',0                
                var listofData = db.ExecuteQuery<ClsAgentCommissionSummary>("exec stp_AgentCommissionSummary {0},{1},{2}",
                    fromDate, tillDate, companyId).ToList();
        ...
        public void SendEmail()
        {
            ...
            General.ShowEmailForm(reportViewer1, "Agent Commission Summary Report");
